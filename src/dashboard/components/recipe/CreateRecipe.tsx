...
import { Cookie, XCircle } from 'phosphor-react'
...
const CreateRecipe = () => {
  ...
  const[ingredients, setIngredients] = useState<[{name: string, amount: number, unit: Types.IUnitType}]>([{name: '', amount: 0, unit: 'grams'}])
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <Input
              ...
              type="text"
              widthFull
              onChange={(v) => SetPreparationTime(Number(v) ? Number(v) : ( v === '' ? 0 : preparationTime ))}
